    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                    ...
                    new Product() { ProductId = 5, CategoryId = 2,ImageUrl="/images/5.jpg", ProductName = "Desk", Price = 1_500, ShowCase=false },
                    ...
                    new Product() { ProductId = 8, CategoryId = 1,ImageUrl="/images/8.jpg", ProductName = "Apple Pen", Price = 2500 , ShowCase=true},
                    new Product() { ProductId = 9, CategoryId = 2,ImageUrl="/images/9.jpg", ProductName = "Aklindan Bir Sayi Tut", Price = 80, ShowCase=true },
                    new Product() { ProductId = 10, CategoryId = 1,ImageUrl="/images/10.jpg", ProductName = "Logitech G29", Price = 8000, ShowCase=true }
            );
        }
    }
}