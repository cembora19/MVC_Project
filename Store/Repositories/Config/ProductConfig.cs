    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                    ...
                    new Product() { ProductId = 5, CategoryId = 2,ImageUrl="/images/5.jpg", ProductName = "Desk", Price = 1_500 },
                    new Product() { ProductId = 6, CategoryId = 1,ImageUrl="/images/6.jpg" ,ProductName = "History", Price = 25 },
                    new Product() { ProductId = 7, CategoryId = 1,ImageUrl="/images/7.jpg", ProductName = "Hamlet", Price = 25 }
            );
        }
    }
}